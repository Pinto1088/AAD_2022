...
architecture Behavioral of Full_Adder_4Bit_woci is
  signal s0: std_logic;
begin
  gate0: entity work.Half_Adder_1Bit
    port map (
      cI => b_0,
      a => a_0,
      s => s_0,
      cO => s0);
  gate1: entity work.Full_Adder_1Bit
    port map (
      a => a_1,
      b => b_1,
      cI => s0,
...
begin
  ...
  gate1: entity work.Full_Adder_1Bit
    port map (
      ...
      s => s_1,
      cO => s1);
  gate2: entity work.Full_Adder_1Bit
    port map (
      a => a_2,
      b => b_2,
      cI => s1,
...
begin
  gate0: entity work.Half_Adder_1Bit
    port map (
      ...
      s => s6,
      cO => s8);
  gate1: entity work.Half_Adder_1Bit
    port map (
      cI => m3_4,
      a => m3_5,
      s => s7,
      cO => s9);
  gate2: entity work.Half_Adder_1Bit
    port map (
      cI => m3_2,
      a => m3_3,
      s => s10,
      cO => s12);
  gate3: entity work.Half_Adder_1Bit
    port map (
      cI => m3_0,
      a => m3_1,
      s => s11,
